...
import boxingRing from './(assets)/fundo-realista-de-um-ringue-de-boxe_52683-134994.avif';
...
export default function Home() {
    ...
    return (
        <div
            ...
            style={{
                backgroundImage: `url(${boxingRing.src})`,
                ...
                <div className="text-center mb-2 w-full">
                    <div className="flex justify-end px-4">
                        <Avatar
                            ...
                            shape="circle"
                            icon={<FiHelpCircle size={24} className="text-amber-400" />}
                        />
                    </div>
                    <h2 className="text-4xl font-bold text-white mb-2">Punch Game</h2>
                        ...
                        {upgrades.map((upgrade) => (
                            ...
                            >
                                ...
                                <div className="flex items-center justify-center gap-1">
                                    ...
                                    <p className="text-sm text-amber-400 font-bold ">{upgrade.price}</p>
                                </div>
                            </div>
                        ))}
                    </div>
